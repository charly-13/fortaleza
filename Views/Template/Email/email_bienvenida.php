	...
	<table align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="text-align:center;">
		<tbody>
			...
			<tr>
				<td>
					<div class="x_sgwrap">
						<p>Hola <?= utf8_decode($data['nombreUsuario']); ?></p>
					</div>
					<p>Bienvenido a nuestra tienda en l&iacute;nea.</p>
					<p>Ahora puedes ralizar tus compras en l&iacute;nea sin salir de casa.</p>
					<p>Accede a tu cuenta con tus credenciales:</p>
					<p>Usuario: <strong><?= $data['email']; ?></strong></p>
					<p>Contrase&ntilde;a: <strong><?= $data['password']; ?></strong></p>

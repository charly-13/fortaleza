<?php 
	...
	class UsuariosModel extends Mysql
	{
		...
		public function insertUsuario(string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, int $status){
			...
			if(empty($request))
			{
				$query_insert  = "INSERT INTO persona(nombres,apellidos,telefono,email_user,password,rolid,status) 
								  VALUES(?,?,?,?,?,?,?,?)";
	        	$arrData = array(
        						$this->strNombre,
        						$this->strApellido,
		...
		public function updatePerfil(int $idUsuario, string $nombre, string $apellido, int $telefono, string $password){
			...
			if($this->strPassword != "")
			{
				$sql = "UPDATE persona SET  nombres=?, apellidos=?, telefono=?, password=? 
						WHERE idpersona = $this->intIdUsuario ";
				$arrData = array($this->strNombre,
								$this->strApellido,
								$this->intTelefono,
